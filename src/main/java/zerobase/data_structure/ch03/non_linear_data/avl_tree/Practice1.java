package zerobase.data_structure.ch03.non_linear_data.avl_tree;
/* AVL 트리
1. LL(Left-Left)
- 회전 1회
- 오른쪽 방향으로 회전
...
//        아니라면 height 정보 리턴
    ...
    //    LL - 오른쪽 방향으로 1회전 Eg. 30-20-10
//    node = 30번 노드, lNode = 20 번 노드
...
//        Insert
        ...
        avl.insert(40);
        avl.insert(50);     // RR
        avl.levelOrder(avl.head); // 20 10 40 30 50

        avl.insert(5);
        avl.insert(7);     // LR
        avl.levelOrder(avl.head); // 20 7 40 5 10 30 50

        avl.insert(60);
        avl.insert(55);     // RL
        avl.levelOrder(avl.head); // 20 7 40 5 10 30 55 50 60
    }
}
